...
__weak void SetUltrasonicFront(float distance) {}
__weak void SetUltrasonicBack(float distance) {}
__weak void SetUltrasonicLeftFront(float distance) {}
__weak void SetUltrasonicRightFront(float distance) {}
__weak void SetUltrasonicLeftBack(float distance) {}
__weak void SetUltrasonicRightBack(float distance) {}
...
void DMA1_Channel6_IRQHandler(void)
{
	...
	else // Normal use
	{
		...
		SetUltrasonicRightFront(sensors[FRONT_RIGHT].COUNTER_DIFF * DISTANCE_COEF);
		SetUltrasonicRightBack(sensors[REAR_RIGHT].COUNTER_DIFF * DISTANCE_COEF);
	}
...
void DMA1_Channel2_IRQHandler(void)
{
	...
	else
	{
		...
		SetUltrasonicLeftFront(sensors[FRONT_LEFT].COUNTER_DIFF * DISTANCE_COEF);
		SetUltrasonicLeftBack(sensors[REAR_LEFT].COUNTER_DIFF * DISTANCE_COEF);
	}
...
void DMA1_Channel3_IRQHandler(void)
{
	...
	else
	{
		...
		SetUltrasonicFront(sensors[FRONT_CENTER].COUNTER_DIFF * DISTANCE_COEF);
		SetUltrasonicBack(sensors[REAR_CENTER].COUNTER_DIFF * DISTANCE_COEF);
	}
